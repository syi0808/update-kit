...
| # | 태스크 | 상태 | 문서 |
|---|--------|------|------|
| 01 | 프로젝트 초기 설정 | [ ] | [01-project-setup.md](tasks/01-project-setup.md) |
| 02 | 핵심 타입 정의 | [ ] | [02-core-types.md](tasks/02-core-types.md) |
| 03 | 설치 채널 감지 | [ ] | [03-channel-detection.md](tasks/03-channel-detection.md) |
